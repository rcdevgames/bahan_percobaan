...
class Model {
    ...
    static Future<Model> searchWorker() async {
      String apiUrl = "http://api.housesolutionsindonesia.com/api/v1/customer/search/d89423b701b777dc87cf74352472adf2fbbff05f";
      String body = jsonEncode({"id_province":"all","id_district":[],"id_category":"all","salary_from":0,"salary_until":0,"rating_from":0,"rating_until":0,"page":1,"limit":100});
